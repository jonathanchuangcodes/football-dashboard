...
export default function Search() {
    ...
    return (
        <div className="ml-24 flex flex-row justify-center align-middle text-black text-lg bg-white border-solid border-4 rounded-lg border-border">
            <Combobox>
                <div className="relative">
                    ...
                    >
                        <Combobox.Options className="border-solid border-4 rounded-lg border-border z-10 mt-1 max-h-60 w-full overflow-auto bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
